...
from src.schemas.photos import Photo as PhotoSchema
from src.schemas.rating import Rating as RatingSchema
...
@router.post("/rate", response_model=RatingSchema)
...
@router.delete("/rate", response_model=RatingSchema)
...
@router.get("/ratings/{photo_id}", response_model=List[RatingSchema])
